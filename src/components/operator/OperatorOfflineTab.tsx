  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#FFFFFF] border border-[#CBD8D1] rounded-[8px] p-5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 border-t border-[#CBD8D1] text-xs">
          <div className="bg-[#F5F8F6] p-3 rounded-[6px] border border-[#CBD8D1]">
            ...
            <div className="text-[10px] text-[#66736D]">Local buffer storage</div>
          </div>
