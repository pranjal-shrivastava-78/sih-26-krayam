      ...
      <div className="max-w-[1440px] mx-auto px-3 sm:px-6 lg:px-8 pt-0.5 pb-2 sm:pb-3 relative z-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 text-center sm:text-left">
            {/* Leaf/Sprout Icon */}
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-md bg-[#0F5A3E] flex items-center justify-center p-1 shadow-xs border border-[#1F7A56] shrink-0">
              <svg className="w-full h-full text-[#8AE1B0]" viewBox="0 0 24 24" fill="currentColor">
