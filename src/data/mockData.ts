...
export const INITIAL_OPERATOR_PROFILE = {
  operatorId: 'OP-SAMRALA-01',
...
export const INITIAL_OPERATOR_QUEUE: Booking[] = [
  {
    id: 'BK-2026-9481',
    farmerId: 'MP-2024-7842',
    farmerName: 'Sardar Gurpreet Singh',
    ...
    centreId: 'centre-samrala',
    centreName: 'Samrala Main Grain Mandi & Procurement Hub',
    centreLocation: 'Grain Market Road, Samrala',
    slot: 'Morning (08:00 AM - 11:30 AM)',
    status: 'IN_QUEUE',
    createdAt: '2026-09-07 14:20',
    queuePosition: 1,
  ...
  {
    id: 'BK-2026-9482',
    farmerId: 'PB-2026-1049',
    farmerName: 'Sh. Manpreet Singh Dhillon',
  ...
  {
    id: 'BK-2026-9483',
    farmerId: 'PB-2026-2188',
    farmerName: 'Smt. Baljit Kaur',
    farmerMobile: '+91 98722 11980',
    cropId: 'crop-mustard',
    cropName: 'Mustard / Rapeseed (सरसों)',
    quantityQuintals: 45,
    expectedDate: '2026-09-08',
  ...
  {
    id: 'BK-2026-9484',
    farmerId: 'PB-2026-3392',
    farmerName: 'Sh. Harnek Singh',
    farmerMobile: '+91 98888 34912',
    cropId: 'crop-wheat',
    cropName: 'Wheat (गेहूं)',
  ...
  {
    id: 'BK-2026-9485',
    farmerId: 'PB-2026-4401',
    farmerName: 'Sh. Jaswinder Singh Grewal',
    farmerMobile: '+91 94170 88231',
    cropId: 'crop-wheat',
    cropName: 'Wheat (गेहूं)',
    quantityQuintals: 75,
    expectedDate: '2026-09-08',
  ...
  {
    id: 'BK-2026-9486',
    farmerId: 'PB-2026-5510',
    farmerName: 'Sh. Surinder Paul',
    farmerMobile: '+91 98155 77123',
    cropId: 'crop-gram',
    cropName: 'Gram / Chana (चना)',
    quantityQuintals: 35,
    expectedDate: '2026-09-08',
    ...
    centreName: 'Samrala Main Grain Mandi & Procurement Hub',
    centreLocation: 'Grain Market Road, Samrala',
    slot: 'Afternoon (02:30 PM - 05:30 PM)',
    status: 'NO_SHOW',
